...
- **Configurable context window** — slider + number input to control how many past messages the model sees (1–50)
...
- **Short-term**: Configurable number of recent messages (default 8, adjustable 1–50 via settings)
...
interface Conversation {
  ...
  contextSize: number      // number of recent messages sent to model (1–50, default 8)
}
```
